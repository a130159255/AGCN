...
class ABSATrainer(object):
    ...
    def update(self, batch):
        ...
        logits, loss, loss_similar_syn, loss_similar_sem, sem_adj, adj_pos,adj = self.model(inputs)
        loss = loss + loss_similar_syn + loss_similar_sem

        # loss = F.cross_entropy(logits, label, reduction="mean") + loss_com + loss_syn + loss_sem
